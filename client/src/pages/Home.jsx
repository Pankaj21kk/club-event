    ...
    <div className="font-sans text-black bg-white">
      ...
      <section className="py-24 bg-neutral-950">
        <div className="max-w-xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 bg-orange-600 text-white text-[11px] font-bold uppercase tracking-[0.12em] px-4 py-1.5 rounded-sm mb-6">
            <i className="ri-mail-send-line" /> Newsletter
          </div>
          <h2 className="font-black text-[clamp(32px,5vw,52px)] text-white leading-[1.05] tracking-tight mb-5">
            Stay in<br />the Loop.
          </h2>
          <p className="text-[16px] text-neutral-400 leading-relaxed mb-10 max-w-sm mx-auto">
            Weekly updates on the hottest events and club recruitments, straight to your inbox.
          </p>

          <div className="flex gap-2 max-w-[440px] mx-auto flex-wrap">
            <input
              type="email"
              placeholder="your@email.com"
              className="flex-1 px-5 py-3.5 bg-neutral-900 border-2 border-neutral-700 text-white text-[14px] rounded-sm outline-none focus:border-orange-600 transition-colors placeholder-neutral-500 min-w-0"
            />
            <button className="inline-flex items-center gap-2 px-6 py-3.5 bg-black text-white border-2 border-black text-[12px] font-bold uppercase tracking-widest rounded-sm hover:bg-orange-600 hover:border-orange-600 transition-all cursor-pointer whitespace-nowrap">
              Subscribe <i className="ri-arrow-right-line text-sm" />
            </button>
          </div>
          <p className="text-[11px] text-neutral-600 mt-4 tracking-wide">No spam. Unsubscribe anytime.</p>
        </div>
      </section>
