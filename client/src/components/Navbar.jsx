      ...
      >
        ...
        <div className="max-w-[1200px] mx-auto px-5 lg:px-8 h-16 flex items-center justify-between gap-4">
          ...
          <Link to="/" className="flex items-center gap-2.5 flex-shrink-0 group">
            <div className="w-9 h-9 bg-black rounded-sm flex items-center justify-center text-white text-lg group-hover:bg-orange-600 transition-colors duration-150">
              <i className="ri-pulse-line" />
            </div>
            <span className="font-extrabold text-[17px] tracking-tight text-black leading-none select-none">
              Campus<span className="text-orange-600">Pulse</span>
            </span>
          </Link>
